...
#TRAIN_FILENAME = 'C:/git/lets_learn/infclean/data/rent_data/NEGSAMP_neo_rent_60_per_city.csv'
TRAIN_FILENAME = "C:\\probabilistic_modeling_framework\\data\\rent_data\\20200227_showcase\\3000_k_2_p_0.2.csv"
EMBEDDING_DIM = 100
batchsize = 1024
...
# negative sampling
neg_df = negative_sampling(train_df, 'city', ['rent'], 5)
...
tsv_name = 'rent_100_1024_1000_{}_{}.tsv'
